// Definig variables and accesing to canvas in html

// I'll take off from spiral equaation
// see: https://en.wikipedia.org/wiki/File:ComplexSinInATimeAxe.gif
...
function run(){
    ...
    let ctx = document.getElementById('tree').getContext('2d'),
  ...
  function forEachStep(callback) {
    for (let i = -startFrom; i < max + startFrom; i += 0.08) {
